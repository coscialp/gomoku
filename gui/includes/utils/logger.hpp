...
namespace Color
{
    ...
    public:
        ...
        constexpr Modifier(const Code &pCode) : code(pCode) {}
...
/// @tparam out (std::ostream) Output stream. Can be std::cout or std::cerr. Default is std::cout
template <class T, std::ostream &out = std::cout>
class Logger
{
private:
    ...
    static constexpr Color::Modifier dark_red = Color::Modifier(Color::FG_DARK_RED);
...
public:
    ...
    /// \param level Level of the message can be INFO, DEBUG, WARNING, ERROR, FATAL
